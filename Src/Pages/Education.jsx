    ...
    <div className="education" ref={pageRef}>
      <section className="education__hero">
        <div className="container">
          <h1 className="reveal">Health Education</h1>
          <p className="education__hero-tagline reveal">Free, expert-driven medical knowledge.</p>
          <p className="education__hero-desc reveal">Actionable guidance from Atria clinicians and our expert network on the most important topics in contemporary medicine. Empowering you to take control of your health.</p>
        </div>
      </section>
      ...
      <section className="education__filters">
        <div className="container">
          <div className="education__filter-bar">
            ...
            <span className="education__count">{filtered.length} {filtered.length === 1 ? 'item' : 'items'}</span>
          </div>
        </div>
      </section>
      ...
      <section className="education__content section">
        <div className="container">
          ...
          {filtered.length === 0 && <p className="education__empty text-center">No content matches your current filters.</p>}
        </div>
      </section>
    </div>
  )
