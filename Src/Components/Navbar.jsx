  ...
  return (
    <header className={`nav ${scrolled ? 'nav--scrolled' : ''} ${mobileOpen ? 'nav--menu-open' : ''}`}>
      <div className="nav__inner">
        <Link to="/" className="nav__logo">atria</Link>
        ...
        <nav className="nav__menu">
          ...
          <Link to="/education" className="nav__link">Content</Link>
          <Link to="/doctors" className="nav__link">Our Doctors</Link>
        </nav>

        <a
          href="https://records.atria.org/sign-in"
          target="_blank"
      ...
      <div className={`nav__mobile ${mobileOpen ? 'nav__mobile--open' : ''}`}>
        <div className="nav__mobile-scroll">
          <div className="nav__mobile-group">
            <span className="nav__mobile-label">Atria Health Institute</span>
            {navigation.InstituteLinks.map(link => (
              <Link key={link.To} to={link.To} className="nav__mobile-item">{link.Label}</Link>
            ))}
          </div>
          <div className="nav__mobile-group">
            <span className="nav__mobile-label">Our Work</span>
            {navigation.WorkLinks.map(link => (
              <Link key={link.To} to={link.To} className="nav__mobile-item">{link.Label}</Link>
            ))}
          </div>
          <div className="nav__mobile-group">
            <Link to="/education" className="nav__mobile-item">Content</Link>
            <Link to="/doctors" className="nav__mobile-item">Our Doctors</Link>
            <a href="https://records.atria.org/sign-in" target="_blank" rel="noopener noreferrer" className="nav__mobile-item">Login</a>
          </div>
        </div>
      </div>
    </header>
